        ...
        <>
            ...
            <>
                ...
                <form
                    ...
                    <input type="submit" value='Crear Cuenta' className="w-full bg-sky-600 text-white uppercase font-bold py-3 rounded hover:cursor-pointer hover:bg-sky-800 transition-colors mb-5" />
